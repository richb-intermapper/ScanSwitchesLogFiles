...
thelog = None                               # the log file to be processed
theHistory = None                           # a long string that contains interesting log file lines
theScanInfo = None                          # Detailed L2 scan info - results of scanning each table
...
def main(argv=None):
    ...
    theHistory = L2HistoryBuffer()
    theScanInfo = L2ScanTables()
